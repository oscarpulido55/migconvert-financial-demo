...
def process_customer_onboarding(spark):
    ...
    # The target is your_gcp_project.fin_core.dim_customers. BigQuery partitioning/clustering should be defined on the table in BigQuery DDL.
...
if __name__ == "__main__":
    ...
    # Optional: Setup Dataset for the demo in BigQuery
    spark.sql("CREATE SCHEMA IF NOT EXISTS `your-gcp-project-id`.fin_core")
