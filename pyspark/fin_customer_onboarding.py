...
def get_spark_session():
    ...
    return SparkSession.builder \
        ...
        .config("temporaryGcsBucket", "your-gcs-bucket/spark_bigquery_temp") \
...
if __name__ == "__main__":
    ...
    # Optional: BigQuery datasets correspond to Hive databases. Ensure the dataset 'fin_core' exists in your GCP project.
