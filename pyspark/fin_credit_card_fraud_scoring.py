...
def create_spark_session():
    ...
    return SparkSession.builder \
        ...
        .config("spark.cloud.google.com.spark.bigquery.tempGcsBucket", "YOUR_GCS_BUCKET_NAME") \
        .config("spark.sql.catalog.spark_catalog", "com.google.cloud.spark.bigquery.BigQueryCatalog") \
        .config("spark.sql.catalog.spark_catalog.project", "YOUR_GCP_PROJECT_ID") \
        .config("spark.sql.catalog.spark_catalog.qualifier", "YOUR_GCP_PROJECT_ID") \
        .getOrCreate()
