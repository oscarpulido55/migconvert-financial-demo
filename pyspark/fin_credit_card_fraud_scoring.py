...
def create_spark_session():
    ...
    # Replaced enableHiveSupport() with BigQuery specific configurations.
    # The spark-bigquery-with-dependencies JAR package is essential for BigQuery connectivity.
    # 'your-gcp-project-id' should be replaced with the actual Google Cloud Project ID.
...
def score_transactions_for_fraud(spark, execution_date):
    ...
    # 1. Load Data
    # Converted from spark.table() for Hive to BigQuery connector read format.
    # BigQuery table paths are in 'project_id.dataset_id.table_name' format.
    ...
    # Converted from insertInto() for Hive to BigQuery connector write format.
    # 'your-gcp-project-id.fin_mart.fraud_scores_daily' should be replaced with the actual BigQuery table path.
    final_output.write \
        .format("bigquery") \
