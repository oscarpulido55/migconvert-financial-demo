...
CREATE TABLE default.tmp_daily_movements_stg AS
WITH credited AS (
    SELECT
...
-- BigQuery equivalent for INSERT OVERWRITE PARTITION (balance_date, region_code)
-- Requires a DELETE for the specific partition(s) followed by an INSERT.
