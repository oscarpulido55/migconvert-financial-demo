...
def run_etl_pipeline(spark: SparkSession, process_date: str):
    ...
    # No direct BigQuery equivalent for SET hiveconf:var, pass parameter directly to queries
    ...
    insert_sql = f"""
        ...
        SELECT
            ...
            CAST(r.amount_base_currency * COALESCE(r.exchange_rate, 1.0) AS BIGNUMERIC(18, 4)) AS normalized_usd_amount,
            r.currency_code,
